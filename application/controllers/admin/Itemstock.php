...
class Itemstock extends Admin_Controller
{
    ...
    public function getitemstockDatatable()
    {
        ...
        if (!empty($dt_response->data)) {
            foreach ($dt_response->data as $key => $value) {
                ...
                $row[]     = $value->salvage_value;
                $row[]     = $value->useful_life;
                $row[]     = $value->annual_depreciation;
    ...
    public function add()
    {
        ...
        if ($this->input->post('expiry_date')) {
            $this->form_validation->set_rules('expiry_date', 'Expiry Date', 'trim|xss_clean');
        }
        if ($this->input->post('salvage_value')) {
            $this->form_validation->set_rules('salvage_value', 'Salvage Value', 'trim|xss_clean');
        }
        if ($this->input->post('useful_life')) {
            $this->form_validation->set_rules('useful_life', 'Useful Life', 'trim|xss_clean');
        }
        if ($this->input->post('annual_depreciation')) {
            $this->form_validation->set_rules('annual_depreciation', 'Annual Depreciation', 'trim|xss_clean');
        }
        ...
        if ($this->form_validation->run() == false) {
            $msg = array(
                ...
                'salvage_value' => form_error('salvage_value'),
                'useful_life' => form_error('useful_life'),
                'annual_depreciation' => form_error('annual_depreciation'),
            );
            ...
            $data = array(
                ...
                'salvage_value' => $this->input->post('salvage_value') ? $this->input->post('salvage_value') : null,
                'useful_life' => $this->input->post('useful_life') ? $this->input->post('useful_life') : null,
                'annual_depreciation' => $this->input->post('annual_depreciation') ? $this->input->post('annual_depreciation') : null,
            );
   ...
   public function update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'useful_life' => $this->input->post('useful_life') ?: null,
                'annual_depreciation' => $this->input->post('annual_depreciation') ?: null,
            );
    
            $this->itemstock_model->add($data); // using 'add' for both insert/update

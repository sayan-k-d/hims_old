...
class Consultcharges extends Admin_Controller
{
    ...
    public function addconsultcharges()
    {
        ...
        $this->form_validation->set_rules(
            'doctor', $this->lang->line('doctor'), ['required',
                ['check_exists', [$this->charge_model, 'valid_doctor_id']],
            ]
        );
        ...
        if ($this->form_validation->run() == false) {
            ...
            $json_array = ['status' => 'fail', 'error' => $msg, 'message' => ''];
        } else {
            $data = [
            ...
            $json_array = ['status' => 'success', 'error' => '', 'message' => $this->lang->line('success_message')];
        }
    ...
    public function update_charges()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $json_array = ['status' => 'success', 'error' => '', 'message' => $this->lang->line('record_added_successfully')];
        }
        echo json_encode($json_array);
    }
    ...
    public function add_ipdconsultcharges()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $json_array = ['status' => 'success', 'error' => '', 'message' => $this->lang->line('record_saved_successfully')];
        }
        echo json_encode($json_array);
    }

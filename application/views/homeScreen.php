    ...
    <section class="position-relative p-0 no-transition" id="home">
            ...
            <div id="rev_slider_18_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
                ...
                <ul>
                    ...
                    <li data-index="rs-44" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/3d469-bg-light-1.jpg" alt=""
                    ...
                    <li data-index="rs-45" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/3d469-bg-light-2.jpg" alt=""
                            data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            class="rev-slidebg" data-no-retina>
                    ...
                    <li data-index="rs-46" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/3d469-bg-light-3.jpg" alt=""
                            data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            class="rev-slidebg" data-no-retina>
                        <div class="small-bg-overlay"></div>
                        <!-- LAYERS -->
        ...
        <ul class="social-icons-simple revicon darkcolor">
            <li class="d-table"><a class="facebook-text-hvr" href="javascript:void(0)"><i
                        class="fab fa-facebook-f"></i></a> </li>
            <li class="d-table"><a class="twitter-text-hvr" href=" javascript:void(0)"><i class="fab fa-x-twitter"></i>
                </a> </li>
                ...
                <div class="container">
                    <div class="main-title style-two d-flex justify-content-md-around align-items-center flex-column flex-md-row text-center text-md-left wow fadeIn"
                        ...
                        <div class="col-md-5 mb-4 mb-md-0">
                            ...
                            <h2 class="pb-0"> We Value Your <span class="family">Family</span> More Than Anyone Else.
                            </h2>
                ...
                <div class="col-md-12">
                    ...
                    <ul class="da-thumbs gallery">
                        <li class="items surgery operations">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-1.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-1.jpg"
                        ...
                        <li class="items clinical patients">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-2.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-2.jpg"
                                    class="text-center" data-fancybox="images">
                                    <div class="search-icon"><i class="fa fa-search"></i> </div>
                        ...
                        <li class="items operations clinical">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-3.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-3.jpg"
                                    class="text-center" data-fancybox="images">
                                    <div class="search-icon"><i class="fa fa-search"></i> </div>
                        ...
                        <li class="items patients operations">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-4.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-4.jpg"
                                    class="text-center" data-fancybox="images">
                                    <div class="search-icon"><i class="fa fa-search"></i> </div>
                                    <h4 class="">Clinical</h4>
                                </a>
                        ...
                        <li class="items surgery patients">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-5.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-5.jpg"
                                    class="text-center" data-fancybox="images">
                                    <div class="search-icon"><i class="fa fa-search"></i> </div>
                        ...
                        <li class="items clinical surgery">
                            ...
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-6.jpg" alt="img">
                            <div class="overlay">
                                <a href="<?php echo base_url(); ?>backend/dist/css/medical/img/portfolio-6.jpg"
                                    class="text-center" data-fancybox="images">
                                    <div class="search-icon"><i class="fa fa-search"></i> </div>
                ...
                <div id="testimonial_slider" class="owl-carousel">
                    ...
                    <div class="testimonial-item item">
                        ...
                        <div class="testimonial-image">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/testimonial-1.png"
                                alt="image">
                        </div>
                    ...
                    <div class="testimonial-item item">
                        ...
                        <!--Image-->
                        <div class="testimonial-image">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/testimonial-2.png"
                                alt="image">
                        </div>
                    ...
                    <div class="testimonial-item item">
                        ...
                        <!--Image-->
                        <div class="testimonial-image">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/testimonial-3.png"
                                alt="image">
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div id="blog-slider" class=" owl-carousel">
                        <div class="item blog-image wow hover-effect fadeInLeft">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image1.jpg"
                                alt="image">
                        </div>
                        <div class="item blog-image wow hover-effect fadeInLeft">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image3.jpg"
                                alt="image">
                        </div>
                        <div class="item blog-image wow hover-effect fadeInLeft">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image4.jpg"
                                alt="image">
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div id="blog-slider-1" class="owl-carousel">
                        <div class="item blog-image2 text-right hover-effect wow fadeInRight">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image2.jpg"
                                alt="image">
                        </div>
                        <div class="item blog-image2 text-right hover-effect wow fadeInRight">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image5.jpg"
                                alt="image">
                        </div>
                        <div class="item blog-image2 text-right hover-effect wow fadeInRight">
                            <img src="<?php echo base_url(); ?>backend/dist/css/medical/img/blog-image6.jpg"
                                alt="image">
                        </div>
                    </div>
                </div>

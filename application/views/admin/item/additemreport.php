                    ...
                    <div class="box-body">
                        <form id="form1" action="" method="post">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" name="search" value="search_filter" class="btn common_btn btn-sm checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-striped table-bordered table-hover allajaxlist" data-export-title="<?php echo $this->lang->line('inventory_item_report'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th ><?php echo $this->lang->line('purchase_price') . " (" . $currency_symbol . ")"; ?></th>
                                        <th >Expiry Date  </th>
                                        <th >Salvage Value  </th>
                                        <th class="text text-right">Useful Life </th>
                                        <th class="text text-right">Depreciation  <?php echo " (".$currency_symbol.")"; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>

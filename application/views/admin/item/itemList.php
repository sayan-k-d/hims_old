                    ...
                    <div class="box box-primary">
                        <div class="box-header ptbnull">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <a href="" data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm additem"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_item'); ?></a>
                                <?php }?>
                            </div><!-- /.box-tools -->
                        </div><!-- /.box-header -->
                        <div class="box-body">
            ...
            <form id="form1" action="<?php echo base_url() ?>admin/item/add" id="itemstockform" name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                        <button type="submit" class="btn common_btn"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </form>
        </div>

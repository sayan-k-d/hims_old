                        ...
                        <form action="<?php echo base_url()?>admin/bill/dashboard" accept-charset="utf-8" method="post" class="form-inline ">
                                    ...
                                    <div class="form-group align-top">
                                        <div> 
                                            ...
                                            <input type="text" name="case_id" class="form-control curve_input" id="case_id" value="<?php echo set_value('case_id');?>" placeholder="<?php echo $this->lang->line('enter_case_id'); ?>">
                                            <span class="text-danger"><?php echo form_error('case_id'); ?></span>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                                        <div> 
                                            <button type="submit" id="serach_btn"  value="search_filter" class="btn common_btn btn-sm checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>   
                                        </div>     
                                    </div> 
                                    <?php 

                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                            <form id="formsearch" accept-charset="utf-8" method="post" class="form-inline align-top">
                                    ...
                                    <div class="form-group">
                                        <div> 
                                            <button type="submit" id="serach_btn" name="search" value="search_filter" class="btn common_btn btn-sm checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>   
                                        </div>     
                                    </div>                                      
                            </form>                            

                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('blood_donor', 'can_view')) { ?>
                                <a href="<?php echo base_url(); ?>admin/bloodbank/search" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('donor_details'); ?></a>
                            <?php }
                            if ($this->rbac->hasPrivilege('blood_issue', 'can_view')) { ?>
                                <a href="<?php echo base_url() ?>admin/bloodbank/issue" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('blood_issue_details'); ?></a>
                            <?php }
                            if ($this->rbac->hasPrivilege('issue_component', 'can_view')) { ?>
                                <a href="<?php echo base_url(); ?>admin/bloodbank/component_issue" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('component_issue'); ?></a>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
        ...
        <div class="modal-content modal-media-content">
            ...
            <form id="bloodgroupstatus" action="<?php echo site_url('admin/bloodbankstatus/status') ?>" method="post" accept-charset="utf-8">
                ...
                <div class="modal-footer">
                    <button type="submit" id="bloodgroupstatusbtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn pull-right"><?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div><!--./row-->
    </div>
            ...
            <form id="donorblood" accept-charset="utf-8" method="post" class="ptt10">
                ...
                <div class="modal-footer sticky-footer">
                    <div class="pull-right">
                        <button type="button" onclick="calculateAmt(true)" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn"><i class="fa fa-calculator"></i> <?php echo $this->lang->line('calculate'); ?></button>
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="donorbloodbtn" class="btn common_btn"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content mx-2">
            ...
            <form id="componentsadd" accept-charset="utf-8" method="post" class="ptt10">
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                        <button type="submit" id="formaddbtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
            ...
            <form id="formadd" accept-charset="utf-8" method="post">
                ...
                <div class="box-footer sticky-footer">
                    <div class="pull-right">
                        ...
                        <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn printsavebtn_issue"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_print'); ?></button>
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="formaddbtn_issue" class="btn common_btn mleft5"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog pup100" role="document">
        <div class="modal-content modal-media-content">
            <form id="formaddComponent" accept-charset="utf-8" method="post">
                ...
                <div class="modal-footer sticky-footer">
                    <div class="pull-right">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="formaddbtn_issue_component" class="btn common_btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                    <div class="pull-right" style="margin-right:10px;">
                        <button type="button" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn pull-right printsavebtn_issue"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save_print'); ?></button>
                    </div>
                </div>
            </form>
        </div>

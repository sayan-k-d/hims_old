    ...
    <div class="box box-primary">
      ...
      <h3 class="box-title"><?php echo $this->lang->line("duty_roster"); ?></h3>
	   ...
	   <div class="box-tools pull-right">  
			<?php if ($this->rbac->hasPrivilege('roster_shift', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/shift"); ?>" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('shift'); ?>  </a>
			<?php } if ($this->rbac->hasPrivilege('roster_list', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/rosterlist"); ?>" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('roster'); ?>  </a>
			<?php } if ($this->rbac->hasPrivilege('roster_assign', 'can_view')) {?>
				<a href="<?php echo base_url("admin/dutyroster/rosterassign"); ?>" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('assign_roster'); ?>  </a>	
			<?php } ?>
	   </div>
     </div>     
     <form id='form111' action="<?php echo site_url('admin/dutyroster/roster_report') ?>" method="post" accept-charset="utf-8">
      ...
      <div class="box-body row">
       ...
       <div class="col-sm-12">
        <button type="submit" name="search" value="search_filter" class="btn common_btn btn-sm pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
       </div>
      </div>
     </form>

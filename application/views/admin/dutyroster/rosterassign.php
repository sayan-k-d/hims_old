    ...
    <div class="box box-primary">
     <div class="box-header with-border">
	  ...
	  <?php if ($this->rbac->hasPrivilege('roster_assign', 'can_add')) {?>
       <a data-toggle="modal" onclick="holdModal('myModal')" id="add_assign_roster" class="btn common_btn btn-sm vital"><i class="fa fa-plus"></i> <?php echo $this->lang->line('assign_roster'); ?></a>
	  <?php } ?>
      </div>
     </div><!-- /.box-header -->
     <div class="box-body">

                                        ...
                                        <div class="row">
                                            <div class="col-md-9">                                           
                                                ...
                                                if($can_edit==0){
                                                    ...
                                                    <button type="submit" name="search" value="saveattendence" class="btn common_btn btn-sm pull-right checkbox-toggle"><i class="fa fa-save"></i> <?php echo $this->lang->line('save_attendance'); ?> </button> <?php
                                              } 
                                                }else{

                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools addmeeting box-tools-md">
                            ...
                            if ($this->rbac->hasPrivilege('birth_record', 'can_add')) {
                                ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn common_btn btn-sm birthrecord"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_birth_record'); ?></a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
            ...
            <form id="formadd" accept-charset="utf-8" method="post" class="ptt10">
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                        <button type="submit" id="formaddbtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn common_btn"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
        </form>
    </div>

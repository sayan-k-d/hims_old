    ...
    <section class="content">
        <div class="row">           
            ...
            if ($this->rbac->hasPrivilege('certificate', 'can_add')) {
                ?>
                <a data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm uploadcontent"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_certificate_template'); ?>
                            </a>
            <?php } ?>                            
                        </div>
                    </div><!-- /.box-header -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content mx-2">
            ...
            <div class="modal-footer">         
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="formaddbtn" class="btn common_btn pull-right"> <i class="fa fa-check-circle"></i>  <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>

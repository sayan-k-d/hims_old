            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        ?>
                            <a data-toggle="modal" href="<?php echo site_url('admin/certificate') ?>" data-target="" class="btn common_btn btn-sm uploadcontent"><i class="fa fa-newspaper-o ftlayer"></i>  <?php echo $this->lang->line('certificate_template'); ?></a>
                        <?php } ?>                          
                        </div>
                    </div>
                    <div class="box-body">
                    ...
                    <form method="post" action="<?php echo base_url('admin/generatecertificate/generatemultiple') ?>">
                        ...
                        ?>
                                <button class="btn common_btn btn-sm printSelected pull-right" type="button" name="generate" title="generate multiple certificate"><?php echo $this->lang->line('generate'); ?></button>
                            <?php } ?>
                            </div>

                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?php if ($this->rbac->hasPrivilege('patient_queue', 'can_edit')) { ?>
                            <button type="submit" name="submit" value="regenerate" class="btn common_btn btn-sm"><?php echo $this->lang->line('reorder_queue'); ?></button>
                        <?php } ?>    
                            <button type="submit" name="submit" value="search" class="btn common_btn btn-sm"><?php echo $this->lang->line('search') ?></button>
                        </div>
                        </form>
                    </div>

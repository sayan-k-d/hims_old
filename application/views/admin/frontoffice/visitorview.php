                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm addvisitor"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_visitor'); ?></a>
                            <?php }?>
                            <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_view')) {?>
                                <a href="<?php echo base_url(); ?>admin/generalcall" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('phone_call_log'); ?></a>
                            <?php }if (($this->rbac->hasPrivilege('postal_dispatch', 'can_view')) || ($this->rbac->hasPrivilege('postal_receive', 'can_view'))) {?>
                                <button type="button" class="btn common_btn btn-sm dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
                            ...
                            <?php }if ($this->rbac->hasPrivilege('complain', 'can_view')) {?>
                                <a href="<?php echo base_url(); ?>admin/complaint" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('complain'); ?></a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/visitors/edit') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ptt10">
                ...
                <div class="modal-footer">
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>"
                            id="editformaddbtn" class="btn common_btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>

                    ...
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm call_log"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_call_log'); ?> </a>
                            <?php }?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
        ...
        <div class="modal-content mx-2">
            ...
            <form id="editformadd" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" id="editformaddbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn common_btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>

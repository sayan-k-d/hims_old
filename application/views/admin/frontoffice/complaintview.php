                        ...
                        <div class="box-tools pull-right">
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('complain', 'can_add')) {?>
                                    <a data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm complain"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_complain'); ?> </a>
                                <?php }?>
                            </div>
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content mx-2">
         ...
         <form id="editformadd" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="ptt10">    
            ...
            <div class="modal-footer">
                <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" id="editformaddbtn" class="btn common_btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
            </div>
        </form>
      </div>
    </div>

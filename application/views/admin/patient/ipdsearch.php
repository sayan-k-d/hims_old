                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" id="addp" class="btn common_btn btn-sm addpatient"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_patient'); ?></a> 
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('discharged_patients', 'can_view')) { ?>
                                <a  href="<?php echo base_url() ?>admin/patient/discharged_patients" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('discharged_patient'); ?></a> 
                            <?php } ?>
                        </div>    
                    </div><!-- /.box-header -->                   
                        <div class="box-body">
...
<?php } ?>
                            ...
                            <button type="submit" class="btn common_btn pull-right"><?php $this->lang->line('save'); ?></button>
                        </form>                       
                    </div><!--./col-md-12--> 
                </div><!--./row--> 
            </div>
...
<?php echo $this->lang->line('credit_limit'); ?></label>
                            ...
                            <button type="submit" class="btn common_btn pull-right"><?php echo $this->lang->line('save'); ?></button>
                        </form>                       
                    </div><!--./col-md-12-->       
                </div><!--./row--> 
            </div>

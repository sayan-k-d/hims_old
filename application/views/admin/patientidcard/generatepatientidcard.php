            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a class="btn common_btn btn-sm  pull-right" type="button" href="<?php echo base_url()?>admin/patientidcard/" title="<?php echo $this->lang->line('id_card_template'); ?>"><i class="fa fa-newspaper-o ftlayer"> </i> <?php echo $this->lang->line('id_card_template'); ?></a>
                    <?php } ?>
                    </div>
                    <div class="box-body">
                      <div class="row">
                        ...
                        <form method="post" action="<?php echo base_url('admin/Generatepatientidcard/generatemultiple') ?>">
                            ...
                            <input type="hidden" name="idcard" id="idcard" value="">
                                <div class="box-header ptbnull">
                                    ...
                                    <button class="btn common_btn btn-sm printSelected pull-right" type="button" name="generate" title="<?php echo $this->lang->line('generate_certificate'); ?>"><?php echo $this->lang->line('generate'); ?></button>
                                </div>

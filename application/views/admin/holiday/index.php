  ...
  <div class="box box-primary">
   <div class="box-header with-border">
    <h3 class="box-title">  <?php echo $this->lang->line('annual_calendar'); ?></h3>
		<div class="box-tools pull-right">
			...
			<button type="button" onclick="add_holiday()" class="btn btn-sm common_btn" data-toggle="tooltip"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button>  
			<?php } ?>
          </div>
   </div>
   ...
   <form class="assign_teacher_form" action="<?php echo base_url(); ?>admin/holiday" method="post" enctype="multipart/form-data">
    <div class="box-body">
     ...
     <button type="submit" id="search_filter" name="search" value="search_filter" class="btn common_btn btn-sm checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
    </div>
   </form>
   ...
   <form role="form" id="add_holiday" method="post" enctype="multipart/form-data" action="">
    ...
    <div class="box-footer">
     <div class="pull-right paddA10">
      <button class="btn common_btn pull-right" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait" value=""><?php echo $this->lang->line('save'); ?></button>
     </div>
   </form>
  </div>
 </div>

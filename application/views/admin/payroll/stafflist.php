                ...
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/payroll') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            <button type="submit" name="search" value="search" class="btn common_btn btn-sm pull-right checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
                    <?php
                    if (isset($resultlist)) {
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($staff["payslip_id"] == 0) { ?>
                                                    <td class="pull-right no-print">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('staff_payroll', 'can_add')) {
                                                            ?>
                                                            <a class="btn common_btn btn-xs checkbox-toggle edit_setting" role="button" href="<?php echo base_url() . "admin/payroll/create/" .strtolower($month_selected) . "/" . $year . "/" . $staff["id"] ?>"><?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('staff_payroll'); ?></a>
                                                        <?php } ?>
                                                    </td>
                                                <?php } ?>
                                            </tr>
                ...
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('admin/payroll/paymentSuccess') ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <button type="submit" class="btn common_btn submit_schsetting pull-right" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>                  
                </div>
            </div>

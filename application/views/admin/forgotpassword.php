...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            .form-top {background:none;
                     
                       border-bottom: 1px solid rgba(255, 255, 255, 0.19);}
            .form-bottom{background: none;box-shadow: 0px 7px 12px rgba(0, 0, 0, 0.29);}
            ...
            .forgot_back {
                background-image: url("../uploads/hospital_content/logo/background.png");
    ...
    <body>
        <!-- Top content -->
        <div class="top-content forgot_back">
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            <div class="forgotbg">
                                ...
                                <div class="form-top-left pt-20">
                                    <h3 class="mb-0 mt-0"><?php echo $this->lang->line('forgot_password'); ?></h3>
                                </div>

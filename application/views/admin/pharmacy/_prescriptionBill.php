...
<a class="btn common_btn addplus-xs add-record mb10" data-added="0"><i class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('add'); ?></a>
                                         </div>               
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
										...
										<a class="btn common_btn addplus-xs add-record mb10" data-added="0"><i class="glyphicon glyphicon-plus"></i>&nbsp;<?php echo $this->lang->line('add'); ?></a>									
                                    </div>
                                    <div class="divider"></div>

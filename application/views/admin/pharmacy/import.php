                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('import_medicine', 'can_view')) { ?>       
                                <a href="<?php echo site_url('admin/pharmacy/exportformat') ?>">
                                    <button class="btn common_btn btn-sm"><i class="fa fa-download"></i> <?php echo $this->lang->line('download_sample_data'); ?></button>
                                </a>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 pt20">
                                    <button type="submit" class="btn common_btn btn-sm pull-right"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_medicine'); ?></button>
                                </div> 
                            </div>
                        </div>
                    </form>

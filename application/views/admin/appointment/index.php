...
<style>
  ...
  .common_btn {
      background-color: #de1054 !important;
    ...
    .common_btn:hover {
      background-color: #9b0033  !important;
      color: #fff;
    }
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <div class="box-tools pull-right">
            ...
            <a data-toggle="modal" data-target="#myModal" class="btn common_btn btn-sm addappointment"> <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_appointment'); ?></a>
            <?php }?>
            
            <?php if ($this->rbac->hasPrivilege('doctor_wise_appointment', 'can_view')) {?>
            <a href="<?php echo base_url("admin/onlineappointment/patientschedule"); ?>" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('doctor_wise'); ?></a>
            <?php }?>
            
            <?php if ($this->rbac->hasPrivilege('patient_queue', 'can_view')) {?>
            <a href="<?php echo base_url("admin/onlineappointment/patientqueue"); ?>" class="btn common_btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('queue'); ?></a>
            <?php }?>
      ...
      <form id="formadd" accept-charset="utf-8" method="post">
        ...
        <div class="modal-footer">
          <div class="pull-right">
            <button type="submit" id="formaddbtn" name="save" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn common_btn"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
          </div>
          <div class="pull-right mr-10">
              <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" name="save_print" class="btn common_btn pull-right printsavebtn"><i class="fa fa-print"></i> <?php echo $this->lang->line('save_print'); ?></button>
          </div>
        </div>
      </form>
    </div>

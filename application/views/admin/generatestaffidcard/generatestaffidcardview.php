            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a class="btn common_btn btn-sm  pull-right" type="button" href="<?php echo base_url('admin/staffidcard/'); ?>" title="<?php echo $this->lang->line('id_card_template'); ?>"><i class="fa fa-newspaper-o ftlayer"></i> <?php echo $this->lang->line('id_card_template'); ?></a>
                    <?php } ?>
                    </div>
                    <div class="box-body">
                        <div class="row">

                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('pathology_test', 'can_add')) {?>
                                <button  class="btn common_btn btn-sm pathology addtest" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Please wait.."><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_pathology_test'); ?></button>
                            <?php }?>

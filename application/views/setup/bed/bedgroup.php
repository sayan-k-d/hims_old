                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <!-- <span class="req"> *</span> -->
                                        <input  name="bed_cost" placeholder="" type="text" class="form-control"  value="<?php echo set_value('bed_cost'); ?>" />
                                        <!-- <span class="text-danger bed_cost"></span> -->
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                    ...
                    <div class="row">                    
                        ...
                        <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Bed Cost</label>
                                        <!-- <span class="req"> *</span> -->
                                        <input  name="bed_cost" placeholder="" type="text"  id="bed_cost" class="form-control"  value="<?php echo set_value('bed_cost'); ?>" />
                                        <!-- <span class="text-danger bed_cost"></span> -->
                                    </div>
                        <div class="col-sm-12">
                            <div class="form-group">

                        ...
                        <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajax_schedit') ?>" class="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <?php
                                           ...
                                           <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
				                            <a href="#schsetting" role="button" class="btn common_btn btn-sm upload_logo pull-right"   data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit_logo'); ?></a>
				                        <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                         <div class="form-group row">
                                            ...
                                            ?>
                                             &nbsp; <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
					                            <a href="#" role="button" class="btn common_btn btn-sm upload_minilogo pull-right"  data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit') . " " . $this->lang->line('small') . " " . $this->lang->line('logo'); ?></a>
					                        <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="relative">     
                                            ...
                                            <?php if (!$app_ver) {
                                                ?>
                                                <button type="button" class="btn common_btn btn-sm impbtntitle3" data-toggle="modal" data-target="#andappModal">Register Your Android App</button>
                                                <?php
                                            }
                                            ?>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                             ...
                                             <?php
						                        ...
						                        ?>
                                                <?php if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) { ?>
					                            &nbsp;<a href="#" role="button" class="btn common_btn btn-sm upload_applogo "   data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit')." ".$this->lang->line('app')." ".$this->lang->line('logo'); ?></a>
					                        <?php } ?>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                ...
                                if ($this->rbac->hasPrivilege('general_setting', 'can_edit')) {
                                    ?>
                                    <button type="button" class="btn common_btn submit_schsetting pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $this->lang->line('save'); ?></button>
                                    <?php
                                }
                                ?>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/admin/updateandappCode') ?>" method="POST" id="andapp_code">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn common_btn" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving...">Save</button>
                </div>
            </form>
        </div>
    </div>
